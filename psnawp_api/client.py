...
class Client:
    ...
    def get_title_id(self, titleId: str, account_id) -> str:
        ...
        Returns:
            str: title name
        """
        # https://m.np.playstation.com/api/trophy/v1/users/me/titles/trophyTitles?npTitleIds=

        #base_uri = "https://m.np.playstation.com/api/catalog/v2/titles"
        base_uri = f"https://m.np.playstation.com/api/trophy/v1/users/{account_id}/titles/trophyTitles?npTitleIds="
        ...
        print(response)
        return response['titles'][0]['trophyTitles'][0]['npCommunicationId']
