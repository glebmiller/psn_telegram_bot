...
class User:
    ...
    def get_game_trophies(self, game_id, version, limit=799):
        ...
        if version == 'PS5':
            response = self.request_builder.get(
                url=f"{User.trophy_base_uri}/v1/users/{self.account_id}/npCommunicationIds/{game_id}/trophyGroups/all/trophies", params=param)
        else:
            response = self.request_builder.get(
                url=f"{User.trophy_base_uri}/v1/users/{self.account_id}/npCommunicationIds/{game_id}/trophyGroups/all/trophies?npServiceName=trophy", params=param)  
        return response
    ...
    def get_game_trophy_names(self, game_id, version, limit=799):
        ...
        if version == 'PS5':
            response = self.request_builder.get(
               url=f"{User.trophy_base_uri}/v1/npCommunicationIds/{game_id}/trophyGroups/all/trophies", params=param)
        else:
            response = self.request_builder.get(
               url=f"{User.trophy_base_uri}/v1/npCommunicationIds/{game_id}/trophyGroups/all/trophies?npServiceName=trophy", params=param)
        return response
